    ...
    <div class="slide-area wow fadeInDown">
        <div id="bootstrap-touch-slider" class="carousel bs-slider slide  control-round indicators-line"
            ...
            <div class="carousel-inner" role="listbox">
                ...
                <div class="item"> <img src="{{asset('asset/images/banne4.png')}}" alt="" title="">
                    <div class="slide-text slide_style_left">
                        <div class="container">
                            <div class="caption_heading" data-animation="animated fadeInLeft"> UNBEATABLE </div>
                            <div class="caption_sub_heading" data-animation="animated fadeInRight">
...
<section>
    <div class="sc-part2 wow fadeInDown">
        <div class="row" id="equalheight">
            ...
            <div class="col-sm-5 col-xs-12 ppp-area">
                &nbsp;
            </div>
        </div>
    </div>
...
<section>
    <div class="sc-part3 wow fadeInDown">
        <div class="row" id="equalheight2">
            <div class="col-sm-7 col-xs-12 ppp-area2">
                &nbsp;
            </div>
            <div class="col-sm-5 col-xs-12 sc-part3">
                <h1>Permits</h1>
...
<section>
    <div class="col-md-12 col-sm-12 col-xs-12 tesimonial-part wow fadeInDown">
        <div class="tes-part">
            <h2>TESTIMONIALS</h2>
            <div id="testimonial4"
                        ...
                        <div class="col-xs-12 col-md-6 col-sm-6">
                            <div class="thumbnail adjust1">
                                <div class="col-md-2 col-sm-2 no-padding">
                                    <img class="media-object img-responsive" src="{{asset('asset/images/tes-icon.png')}}">
                                </div>
